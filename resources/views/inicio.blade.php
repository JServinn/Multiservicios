...
<head>
  ...
  <link rel="stylesheet" href="css/bootstrap.css" type="text/css" />
    <link rel="stylesheet" href="css/multiservicios.css" type="text/css" />
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
    ...
    <link rel="stylesheet" href="css/colors.php?color=7F8000" type="text/css" />

  <!-- Document Title
	============================================= -->
  <title>Inicio | Multiservicios</title>
        ...
        <div class="row justify-content-between">
          <div class="col-12 col-md-auto">
            ...
            <ul id="top-social">
              ...
              <li><a href="#" class="si-dribbble"><span class="ts-icon"><i class="icon-dribbble"></i></span><span
          ...
          <div class="col-12 col-md-auto">
            ...
            <div class="top-links">
              <ul class="top-links-container">
                <li class="top-links-item"><a href="#">Sucursales</a>
                  ...
                  <li class="top-links-item"><a href="faqs">Preguntas?</a></li>
                  <li class="top-links-item"><a href="contacto">Contacto</a></li>
              </ul>
            </div><!-- .top-links end -->
      ...
      <div class="container">
        <div class="header-row">
          ...
          <div id="logo" class="ms-auto ms-lg-0 me-lg-auto">
            <a href="inicio" class="standard-logo"><img src="/images/logo_multi4.png"
                alt="Canvas Logo"></a>
            <a href="inicio" class="retina-logo"><img src="/images/logo_multi4.png"
                alt="Canvas Logo"></a>
          </div><!-- #logo end -->
          ...
          <div class="header-misc d-none d-lg-flex">
            ...
            <ul class="header-extras">
              ...
              <li>
                ...
                <div class="he-text">
                  Nuestro correo
                  <span>info@multiservicios.com</span>
                </div>
              </li>
              <li>
          ...
          <div class="header-row justify-content-between flex-row-reverse flex-lg-row justify-content-lg-center">
            ...
            <nav class="primary-menu with-arrows">
              ...
              <ul class="menu-container">
                <li class="menu-item current"><a class="menu-link" href="inicio">
                    <div>INICIO</div>
                  </a></li>
                <li class="menu-item"><a class="menu-link" href="servicios">
                  ...
                  <ul class="sub-menu-container">
                    <li class="menu-item"><a class="menu-link" href="#">
                        <div>Gestion de vivienda</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="#">
                        <div>Planificacion de la construccion</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="#">
                        <div>Casas Verdes</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="#">
                        <div>Diseño Arquitectonico</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="#">
                        <div>Planificacion interior</div>
                      </a></li>
                  </ul>
                </li>
                <li class="menu-item "><a class="menu-link" href="sobre-nosotros">
                    <div>SOBRE NOSOSTROS</div>
                  </a></li>
                <li class="menu-item "><a class="menu-link" href="proyectos">
                    <div>PROYECTOS</div>
                  </a>
                  <ul class="sub-menu-container">
                    <li class="menu-item"><a class="menu-link" href="proyectos2">
                        <div>2 Columnas</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="proyectos3">
                        <div>3 Columnas</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="proyectos4">
                        <div>4 Columnas</div>
                      </a></li>
                    <li class="menu-item"><a class="menu-link" href="proyectos2">
                        <div>5 Columnas</div>
                ...
                <li class="menu-item"><a class="menu-link" href="inversores">
                    <div>INVERSORES</div>
                  </a></li>
                <li class="menu-item"><a class="menu-link" href="faqs">
                    <div>FAQS</div>
                  </a></li>
            ...
            <div class="container">
              <div class="slider-caption">
                <div>
                  ...
                  <p class="d-none d-sm-block">Conoce nuestro trabajo y elija entre una gama amplia de elementos de
                    acuerdo con tus necesidades.</p>
                </div>
              </div>
            </div>
            <div class="swiper-slide-bg"
              style="background-image: url('demos/construction/images/pag/1a.jpg'); background-position: center top;">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="container">
              <div class="slider-caption slider-caption-right">
                <div>
                  <h2>Conoce nuestros costos</h2>
                  <p class="d-none d-sm-block">En esta empresa nos preocupamos por tu economía; y sin duda te
                    sorprenderá lo económico
                    y accesible que puede ser la elaboración de tu trabajo personalizado.</p>
                </div>
              </div>
            </div>
            <div class="video-wrap">
              ...
              <div class="video-overlay" style="background-color: rgba(127,128,0,0.1);"></div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="container">
              <div class="slider-caption">
                <div>
                  <h2>Construcciones de calidad</h2>
                  <p class="d-none d-sm-block">Te sorprenderá ver los resultados finales de tu creación.</p>
                </div>
              </div>
            </div>
            <div class="swiper-slide-bg"
              style="background-image: url('demos/construction/images/pag/10a.jpg'); background-position: center bottom;">
            </div>
          </div>
        </div>
      ...
      <div class="content-wrap">
          ...
          <div class="container clearfix">
            <div class="row align-items-center">
              <div class="col-12 col-lg">
                <h3 style="letter-spacing: 2px;">Comienza a planificar tu nueva casa de ensueño con nosotros.</h3>
                <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</span>
              </div>
              <div class="col-12 col-lg-auto mt-4 mt-lg-0">
                <a href="#" class="button button-large button-circle button-black m-0">Inicia Ahora</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section parallax dark"
          ...
          <div class="video-wrap" style="z-index: 1;">
            <div class="video-overlay" style="background: rgba(127,128,0,0.9);"></div>
          </div>
          ...
          <div class="row align-items-stretch col-mb-50">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="feature-box fbox-plain">
                ...
                <div class="fbox-content">
                  <h3>Asistencia durante la construcción</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem minima, facere distinctio placeat.
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="feature-box fbox-plain">
                ...
                <div class="fbox-content">
                  <h3>Constructores inteligentes</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem minima, facere distinctio placeat.
                  </p>
                </div>
              </div>
        ...
        <div class="section mb-0">
          <h2 class="center mb-0 ls1">Algunos de Nuestros Proyectos:</h2>
        </div>
        ...
        <div id="portfolio" class="portfolio row grid-container g-0">
                ...
                <div class="bg-overlay">
                  <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                    <a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                      data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="icon-line-ellipsis"></i></a>
                  </div>
          ...
          <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-illustrations">
            <div class="grid-inner">
              <div class="portfolio-image">
                <img src="demos/construction/images/pag/16t.jpg" alt="Wavelength Structure">
                <div class="bg-overlay">
                  <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                    <a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                      data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="icon-line-ellipsis"></i></a>
          ...
          <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-graphics pf-uielements">
            <div class="grid-inner">
              <div class="portfolio-image">
                <img src="demos/construction/images/pag/19t.jpg" alt="Greenhouse Garden">
                <div class="bg-overlay">
                  <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                    <a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                      data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="icon-line-ellipsis"></i></a>
          ...
          <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-graphics pf-illustrations">
            <div class="grid-inner">
              <div class="portfolio-image">
                <img src="demos/construction/images/pag/18t.jpg" alt="Space Station">
                <div class="bg-overlay">
                  <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                    <a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                      data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="icon-line-ellipsis"></i></a>
          ...
          <article class="portfolio-item col-12 col-sm-6 col-md-4 col-lg-3 pf-uielements pf-icons">
            <div class="grid-inner">
              <div class="portfolio-image">
                <img src="demos/construction/images/pag/17t.jpg" alt="Bent Architecture">
                <div class="bg-overlay">
                  <div class="bg-overlay-content dark" data-hover-animate="fadeIn">
                    <a href="#" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn"
                      data-hover-animate-out="zoomOut" data-hover-speed="350"><i class="icon-line-ellipsis"></i></a>
        ...
        <a href="contacto"
          class="button button-3d border-bottom-0 button-full center text-end bottommargin-lg fw-light font-primary"
          style="font-size: 26px;">
          <div class="container clearfix">
            ¿Le gustaría construir la casa de sus sueños con nosotros? <strong>Pregunte aqui</strong> <i
        ...
        <div class="container topmargin-lg cleafix">
          ...
          <div class="row col-mb-50">
            <div class="col-md-8">
              ...
              <div class="tabs tabs-justify mb-0 clearfix" id="construction-tabs">
                ...
                <ul class="tab-nav clearfix">
                  <li><a href="#construction-tab-1">Por que nosotros?</a></li>
                  <li><a href="#construction-tab-2">Nuestra etica de trabajo</a></li>
                  <li><a href="#construction-tab-3">Equipo</a></li>
                  <li><a href="#construction-tab-4">Sucursales</a></li>
                </ul>

                <div class="tab-container">

                  <div class="tab-content clearfix" id="construction-tab-1">
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit, ultrices egestas ullamcorper nunc hac
                      conubia vitae, suscipit habitant tortor phasellus dictum volutpat. Magnis augue elementum curae
                      aptent class per curabitur ultricies sociosqu ligula, accumsan congue iaculis ullamcorper
                      venenatis
                      pharetra at ut felis nam nibh, cubilia nostra luctus ornare montes volutpat hendrerit enim
                      tincidunt. Magna phasellus consequat rutrum diam risus egestas arcu in, integer lobortis convallis
                      conubia curabitur pretium cursus commodo, mattis a habitasse sed fames nec lacus. </p>
                    <div class="row col-mb-30">
                      <div class="col-sm-6 col-lg-3 text-center">
                        <div class="counter ls1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="964"
                            data-refresh-interval="50" data-speed="2000"></span></div>
                        <h5>Techados construidos</h5>
                      </div>

                      <div class="col-sm-6 col-lg-3 text-center">
                        <div class="counter ls1 fw-semibold" style="color: #D2D2D2;"><span data-from="100"
                            data-to="8514" data-refresh-interval="50" data-speed="2500"></span></div>
                        <h5>Empleados</h5>
                      </div>

                      <div class="col-sm-6 col-lg-3 text-center">
                        <div class="counter ls1 fw-semibold" style="color: #D2D2D2;"><span data-from="100" data-to="458"
                            data-refresh-interval="50" data-speed="3500"></span></div>
                        <h5>Clientes satisfechos</h5>
                      </div>

                      <div class="col-sm-6 col-lg-3 text-center">
                        <div class="counter ls1 fw-semibold" style="color: #D2D2D2;"><span data-from="14" data-to="159"
                  ...
                  <div class="tab-content clearfix" id="construction-tab-2">
                    ...
                    <p>Morbi tincidunt, dui sit amet facilisis feugiat, odio metus gravida ante, ut pharetra massa metus
                      ...
                      ligula in ligula suscipit aliquam. Praesent in eros vestibulum mi adipiscing adipiscing. Morbi
                      facilisis. Curabitur ornare consequat nunc. Aenean vel metus. Ut posuere viverra nulla. Aliquam
                      erat volutpat. Pellentesque convallis. Maecenas feugiat, tellus pellentesque pretium posuere,
                    ...
                    <div class="row col-mb-30">
                      <div class="col-sm-6 col-md-4">
                        <ul class="iconlist mb-0">
                          <li><i class="icon-ok"></i> 100% Garantía</li>
                          <li><i class="icon-ok"></i> Trabajo de calidad</li>
                          <li><i class="icon-ok"></i> Confiable</li>
                        </ul>
                      </div>
                      <div class="col-sm-6 col-md-4">
                        <ul class="iconlist mb-0">
                          <li><i class="icon-ok"></i> Éticos</li>
                          <li><i class="icon-ok"></i> Innovadores</li>
                          <li><i class="icon-ok"></i> Perfeccionistas</li>
                        </ul>
                      </div>
                      <div class="col-sm-6 col-md-4">
                        <ul class="iconlist mb-0">
                          <li><i class="icon-ok"></i> Amigables &amp; Serviciales</li>
                          <li><i class="icon-ok"></i> Atención personalizada</li>
                          <li><i class="icon-ok"></i> Disponibilidad 24x7</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-7">
                        ...
                        <div class="row col-mb-30">
                          ...
                          <div class="col-md-6">
                            ...
                            <abbr title="Email Address"><strong>Correo:</strong></abbr> info@multiservicios.com
                          </div>
                        </div>
                      </div>
                      <div class="col-md-5">
            ...
            <div class="col-md-4">
              ...
              <div class="widget quick-contact-widget form-widget clearfix">
                <h4>Formulario de cotización rápida</h4>
                ...
                <form id="quick-contact-form" name="quick-contact-form" action="include/form.php" method="post"
                  ...
                  <button type="submit" id="quick-contact-form-submit" name="quick-contact-form-submit"
                    class="button button-small button-3d m-0" value="submit">Envía E-mail</button>
                </form>
          ...
          <div class="row col-mb-50">
            <div class="col-md-5">
              ...
              <p>Valoramos a nuestros Clientes. Nos esforzamos por brindar servicios de calidad. Está invitado a unirse
                a nuestra lista de clientes y disfrutar de nuestros servicios.<a href="#">Leer más...</a></p>
              ...
              <div id="oc-posts" class="owl-carousel posts-carousel carousel-widget posts-md" data-margin="20"
                ...
                <div class="oc-item">
                  <div class="entry">
                    ...
                    <div class="entry-meta">
                      <ul>
                        <li>10 Feb 2021</li>
                        <li><a href="#comments">13 comentarios</a></li>
                      </ul>
                    </div>
                ...
                <div class="oc-item">
                  <div class="entry">
                    ...
                    <div class="entry-title title-sm nott">
                      <h3><a href="#">Bienes raices acaba de subir sus precios</a></h3>
                    </div>
                    <div class="entry-meta">
                      <ul>
                        <li>24 Feb 2021</li>
                        <li><a href="#comments">21 Commentarios</a></li>
                      </ul>
                    </div>
                    <div class="entry-content">
                ...
                <div class="oc-item">
                  <div class="entry">
                    ...
                    <div class="entry-meta">
                      <ul>
                        <li>5 May 2021</li>
                        <li><a href="#comments">6 Commentarios</a></li>
                      </ul>
                    </div>
                    <div class="entry-content">
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, asperiores quod est
            ...
            <div class="row">
              ...
              <div class="col-lg-5 topmargin-sm">
                <div class="heading-block border-bottom-0">
                  ...
                  <span class="ls1">Cinco puntos que definen nuestra Fiabilidad.</span>
                </div>

                <ul class="iconlist iconlist-large iconlist-color">
                  <li><i class="icon-ok"></i> Líder del mercado desde 1915</li>
                  <li><i class="icon-ok"></i> Resultados positivos dentro de los plazos</li>
                  <li><i class="icon-ok"></i> 100% Fiabilidad &amp; Garantía</li>
                  <li><i class="icon-ok"></i> Equipo profesional</li>
                  <li><i class="icon-ok"></i> Soporte inigualable después de la finalización del proyecto</li>
                </ul>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-9">
              <div class="widget clearfix">
                  ...
                  <img src="images/logo_footer2.png" alt="Image" class="alignleft"
                       style="margin-top: 8px; padding-right: 18px; border-right: 1px solid #4A4A4A;">

                <p>Estándares de diseño <strong>Simple</strong>, <strong>Creativos</strong> &amp;
                  <strong>Flexibles</strong>
                  Con un enfoque de Retina &amp; Enfoque receptivo. Explore las ventajas y productos que
                ...
                <div class="row col-mb-30">
                  ...
                  <div class="col-lg-3 col-6 widget_links">
                    <ul>
                      <li><a href="#">CORPORACION</a></li>
                      <li><a href="#">AGENCIA</a></li>
                      <li><a href="#">eCOMMERCE</a></li>
                      <li><a href="#">PERSONAL</a></li>
                      <li><a href="#">UNA PAGINA</a></li>
                    </ul>
                  </div>
                  ...
                  <div class="col-lg-3 col-6 widget_links">
                    <ul>
                      ...
                      <li><a href="#">PAGINAS DE DESTINO</a></li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="widget subscribe-widget clearfix">
                ...
                <div class="row col-mb-30">
                  <div class="col-12 col-sm-6 clearfix">
                    ...
                    <a href="#"><small style="display: block; margin-top: 3px;"><strong>Danos un like</strong><br>en
                        Facebook</small></a>
                  </div>
                  <div class="col-12 col-sm-6 clearfix">
                    ...
                    <a href="#"><small style="display: block; margin-top: 3px;"><strong>Subscribete</strong><br>en RSS
                        Feeds</small></a>
                  </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="col-12 col-md-auto text-center text-md-end">
              <div class="copyrights-menu copyright-links clearfix">
                <a href="inicio">INICIO</a>/<a href="sobre-nosotros">SOBRE NOSOTROS</a>/<a href="#">EQUIPO</a>/<a
                  href="#">CLIENTES</a>/<a href="#">FAQs</a>/<a href="contacto">CONTACTO</a>
              </div>
            </div>
          </div>
