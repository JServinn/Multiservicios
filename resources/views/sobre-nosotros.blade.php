...
<head>
  ...
  <!-- Document Title
	============================================= -->
  <title>Sobre nosotros | Multiservicios</title>
...
<body class="stretched">
  ...
  <!-- #page-title end -->
      <section id="page-title" class="page-title-parallax page-title-dark"
                                               style="background: url('/demos/construction/images/slider/martillo.png') bottom center / cover; padding: 100px 0;"
    ...
    <section id="content">
      <div class="content-wrap">
          ...
          <div class="row clearfix">
            <div class="col-lg-6">
              <div class="heading-block border-bottom-0 bottommargin-sm">
                <h3>SERVICIOS</h3>
                <span>Lorem ipsum dolor sit amet consectetur adipiscing elit cras mi, malesuada odio massa euismod
                  magna proin ac dictum, nibh pharetra magnis senectus facilisis felis a conubia.</span>
              </div>
              <p>Lorem ipsum dolor sit amet consectetur adipiscing elit cras mi, malesuada odio massa euismod magna
                proin ac dictum, nibh pharetra magnis senectus facilisis felis a conubia. Parturient phasellus
                lacinia pretium aptent vel turpis volutpat sodales ultricies, cubilia neque ante magnis ornare lacus
                habitasse interdum erat cras, mus eros scelerisque nunc tempor diam porttitor mauris. </p>
              <a href="#" class="button button-3d ms-0 bottommargin-sm">Leer más...</a>
            </div>
              ...
              <div class="row align-items-stretch clearfix">
                ...
                <div class="col-md-6 bottommargin">
                  <div class="feature-box fbox-plain">
                    ...
                    <div class="fbox-content">
                      <h3>Asistencia durante el proyecto</h3>
                      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem minima, facere distinctio
                        placeat.</p>
                    </div>
                  </div>
        ...
        <div class="container clearfix">
          <div class="row clearfix">
              ...
              <div id="oc-posts" class="owl-carousel posts-carousel carousel-widget" data-margin="20" data-nav="true"
                  ...
                  <div class="team">
                    ...
                    <div class="team-desc">
                      <div class="team-title"><a href="#">
                          <h4>John Doe</h4>
                        </a><span>Construction engineer</span></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="oc-item">
                  <div class="team">
                    ...
                    <div class="team-desc">
                      <div class="team-title"><a href="#">
                          <h4>Alan Fresco</h4>
                        </a><span>Vehicle park manager</span></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="oc-item">
                  <div class="team">
                    ...
                    <div class="team-desc">
                      <div class="team-title"><a href="#">
                          <h4>Diseñador de soporte</h4>
                        </a><span>Gefe de claridad</span></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-5">
              ...
              <p>Valoramos a nuestros clientes. Nos esforzamos por brindar servicios de calidad. Está invitado a
                unirse a nuestra lista de clientes y disfrutar de nuestros servicios.<a href="#">Leer Más...</a></p>
        ...
        <a href="contacto"
          class="button button-3d border-bottom-0 topmargin-sm button-full center text-end bottommargin fw-light font-primary"
          style="font-size: 26px;">
          <div class="container clearfix">
            ¿Le gustaría construir la casa de sus sueños con nosotros? <strong>Pregunte aquí</strong> <i
            ...
            <div class="row">
              ...
              <div class="col-lg-5 topmargin-sm">
                <div class="heading-block border-bottom-0">
                  ...
                  <span class="ls1">Cinco puntos que definen la Fiabilidad.</span>
                </div>
